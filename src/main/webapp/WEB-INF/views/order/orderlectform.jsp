...
<body>
                        ...
                        <c:choose>
                           ...
                           <c:otherwise>
                              <c:forEach var="userChoiceLect" items="${userChoiceLectList }" varStatus="loop">
                                 <tr>
                                    <td>${loop.count }<input type="hidden" class="form-control" name="lectno" value="${userChoiceLect.no }"/></td>
                                    <td>${userChoiceLect.lectTitle }</td>
                                    <td>${userChoiceLect.discountPrice } 원</td>
                                    <td ></td>
                                 </tr>
                              </c:forEach>
                           </c:otherwise>
   ...
   $("#btn-open-coupon-modal").on('click', function() {
      ...
      $.getJSON("/coupon/couponDetails.hta", function(result) {
