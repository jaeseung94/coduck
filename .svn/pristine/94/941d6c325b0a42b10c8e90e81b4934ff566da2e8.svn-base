	...
	<ul class="navbar-nav ml-auto">
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			<div
				...
				</a> <a class="dropdown-item text-center small text-gray-500" href="#">모든
					알림 보기</a>
			</div></li>
		...
		<li class="nav-item dropdown no-arrow mx-1"><a
			...
			<div
				...
				<h6 class="dropdown-header">1:1 문의</h6>
				<a class="dropdown-item d-flex align-items-center" href="#">
		...
		<li class="nav-item dropdown no-arrow"><a
			...
			aria-expanded="false"> <span
				class="mr-2 d-none d-lg-inline text-gray-600 small">${LU.name }</span> <img
				class="img-profile rounded-circle" src="/resources/images/admin/daeilkinng.jpg">
		</a> <!-- Dropdown - User Information -->
			<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"aria-labelledby="userDropdown">
				<a class="dropdown-item" href="../home.hta"> <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>홈페이지로</a>
				
				<div class="dropdown-divider"></div>
					<c:if test="${not empty LU  and LU.role eq 'A'}">
					<a class="dropdown-item" href="logout.hta"> 
